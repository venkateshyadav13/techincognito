...
elseif (strpos($result2, "CVV LIVE")){
...
elseif ((strpos($result2, "INSUFFICIENT FUNDS")) || (strpos($result2, "insufficient_funds"))){
...
elseif ((strpos($result2, "CCN LIVE")) || (strpos($result2, "incorrect_cvc")) || (strpos($result2, "The card's security code is incorrect."))){
...
elseif ((strpos($result2, "TRANSACTION NOT ALLOWED")) || (strpos($result2, "transaction_not_allowed"))){
...
elseif ((strpos($result2, 'INCORRECT CARD NUMBER')) || (strpos($result2, 'Your card number is incorrect.')) || (strpos($result2, 'incorrect_number'))){
...
elseif (strpos($result2, '"status":"success"')){
...
elseif (strpos($result2, "lock_timeout")){
...
elseif (strpos($result2, "NVAILD EXPIRY MONTH")){
...
elseif (strpos($result2, "Error processing payment")){
...
elseif (strpos($result2, 'CARD NOT SUPPORTED')){
...
Result - '.$response.' Status >> '.$status.'</b>

';

$umass = "<b>𒀭  MASS Shopfiy  𒀭
